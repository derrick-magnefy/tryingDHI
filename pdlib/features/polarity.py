...
Usage:
    from pdlib.features.polarity import calculate_polarity, POLARITY_METHODS

    polarity = calculate_polarity(waveform, method='first_peak', sample_interval=4e-9)
"""
...
def calculate_polarity(waveform, method='first_peak', sample_interval=4e-9, baseline_samples=50):
    """
